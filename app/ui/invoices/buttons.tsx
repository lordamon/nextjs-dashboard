import { deleteInvoice, StateDelete } from "@/app/lib/actions";
...
export function DeleteInvoice({ idx }: { idx: string }) {
  const deleteInvoiceWithId = deleteInvoice.bind(null, idx);
