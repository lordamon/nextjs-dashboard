    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <div className={styles.shape2}>xxxxxxx</div>
          <p className={lusitana.className}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus mollitia, quae nulla culpa cum fugiat repellat quidem facere iure quia?</p>
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image src="/hero-mobile.png" width={650} height={620} className="md:hidden" alt="mobile" />
        </div>
      </div>
    </main>
  );
